...
${validate_component(BackgroundContainer, "BackgroundContainer").$$render(
    $$result,
    {
      backdrop: $page.url.pathname.includes("metaverse") || $page.url.pathname.includes("games") || $page.url.pathname.includes("privacy-policy") || $page.url.pathname.includes("/r") || $page.url.pathname.includes("content")
    },
    {},
    {
      default: () => {
...
//# sourceMappingURL=_layout.svelte-e9a954a0.js.map
