import { c as create_ssr_component, b as subscribe, v as validate_component, d as add_attribute, g as getContext, e as escape } from './index-4bd6642a.js';
...
const css = {
  code: ".full-wh.svelte-ntgtfr::-webkit-scrollbar{display:none}.full-wh.svelte-ntgtfr{position:absolute;top:80px;left:0px;bottom:0px;width:100%;-ms-overflow-style:none;scrollbar-width:none}.bg-animation.svelte-ntgtfr{position:fixed;top:-8500px;left:-8000px;width:100%;height:100%}.stars.svelte-ntgtfr{position:fixed;top:-5000px;left:-5000px;width:20000px;height:20000px;background-repeat:repeat;animation:svelte-ntgtfr-Odd 150s linear infinite;opacity:0.05;background-image:url(/background/Dust1.png)}.stars1.svelte-ntgtfr{position:fixed;top:-5000px;left:-5000px;width:20000px;height:20000px;background-repeat:repeat;animation:svelte-ntgtfr-Even 80s linear infinite;opacity:0.07;background-image:url(/background/Dust2.png)}@keyframes svelte-ntgtfr-Odd{from{transform:translate(0px, 0px)}to{transform:translate(-1000px, 1200px)}}@keyframes svelte-ntgtfr-Even{from{transform:translate(0px, 0px)}to{transform:translate(1250px, 1000px)}}",
  map: null
};
...
${validate_component(BackgroundContainer, "BackgroundContainer").$$render(
    ...
    {
      default: () => {
        return `<div class="${"full-wh svelte-ntgtfr"}">
		<div class="${"bg-animation svelte-ntgtfr"}"><div class="${"stars svelte-ntgtfr"}"></div>
			<div class="${"stars1 svelte-ntgtfr"}"></div></div>
		</div>
...
//# sourceMappingURL=_layout.svelte-6201f0c8.js.map
