...
${validate_component(BackgroundContainer, "BackgroundContainer").$$render(
    ...
    {
      default: () => {
        return `<div class="${"full-wh svelte-1mvhsq7"}">
    <video autoplay muted loop class="${"bg-animation svelte-1mvhsq7"}" src="${"/background/background.mp4"}"></video></div>
...
//# sourceMappingURL=_layout.svelte-c6fc1ae1.js.map
